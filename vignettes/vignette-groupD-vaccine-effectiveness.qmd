...
The standard Cox baseline hazard absorbs the population-average FoI through calendar time, but it cannot distinguish *who* was exposed to *how much* infectious pressure — particularly when exposure is structured by age and by the vaccination status of contacts. By modelling the FoI explicitly and incorporating it as an offset, we attempt to separate these confounded signals.
